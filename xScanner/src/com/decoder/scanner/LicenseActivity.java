...
public class LicenseActivity extends PreferenceActivity implements Preference.OnPreferenceClickListener, LicenseCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar myToolbar = (Toolbar) findViewById(R.id.prefernceToolbarLicense);
    ...
    public void showActivationCodeDialog() {
        ...
        final View dialogView = inflater.inflate(R.layout.activation_code_dialog, null);
        dialogBuilder.setView(dialogView);

        final EditText edt = (EditText) dialogView.findViewById(R.id.activationCodeEdit);
        ...
        dialogBuilder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if (actCode.isEmpty() || actCode.length() == 0 || edt.equals("") || edt == null) {
